...
import exemplo.autentificacao.auth.dto.AuthResponse;
import exemplo.autentificacao.auth.dto.LoginRequest;
import exemplo.autentificacao.auth.dto.RegisterRequest;
import exemplo.autentificacao.security.JwtService;
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest request) {
        ...
        if (userRepository.existsByUsername(username)) {
            return ResponseEntity.status(HttpStatus.CONFLICT)
                    .body(Map.of("message", "Username ja cadastrado."));
        }
