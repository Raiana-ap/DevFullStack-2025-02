    ...
    return (
        <>
            ...
            <form onSubmit={handleAddProduct}>
                ...
                <label>
                    Categoria:
                    <select name="categoria" id="categoria" value={category} onChange={handleCategoryChange} >
             ...
             <label>
                    ...
                    <select name={categoryFilter} onChange={(event) => setCategoryFilter(event.target.value)} >
            ...
            <ul>
                {filteredProducts.map((product) => (
                    <li key={product.id}>
                        ...
                        <button onClick={() => handleRemoveProdct(product.id)}>Remover</button>
                    </li>
                ))}
            </ul>
        </>
